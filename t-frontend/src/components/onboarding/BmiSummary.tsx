...
export default function BmiSummary({ plan }: BmiSummaryProps) {
  return (
    <div className="flex items-center justify-between gap-6 rounded-2xl bg-bg-card p-5 shadow-sm dark:bg-dark-bg-card border border-border dark:border-dark-border">
      <div>
        <p className="text-xs font-light text-text-secondary dark:text-dark-text-secondary">
          Your BMI
        </p>
        <p className="mt-1 text-3xl font-bold tracking-tight text-text-primary dark:text-dark-text">
          {plan.bmi.toFixed(1)}
        </p>
        <p className="mt-1 text-sm font-medium text-text-primary dark:text-dark-text">
      ...
      <div className="text-right">
        ...
        <p className="mt-1 text-xl font-semibold text-text-primary dark:text-dark-text">
