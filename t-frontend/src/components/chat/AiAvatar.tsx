...
export function GeminiAiLogo({ className = "h-7 w-7" }: { className?: string }) {
  ...
  const sparkle1Id = `gemini-sparkle1-${id}`;
  const sparkle2Id = `gemini-sparkle2-${id}`;
  ...
  return (
    <svg
      ...
      className={`shrink-0 overflow-visible drop-shadow-[0_0_5px_rgba(255,255,255,0.95)] dark:drop-shadow-[0_0_4px_rgba(16,185,129,0.35)] ${className}`}
      aria-hidden="true"
    >
      <defs>
        ...
        {/* Primary satellite sparkle gradient - pure white shimmer */}
        <linearGradient id={sparkle1Id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" stopOpacity="1" />
          <stop offset="65%" stopColor="#FFFFFF" stopOpacity="0.9" />
          <stop offset="100%" stopColor="#FFFFFF" stopOpacity="0.75" />
        </linearGradient>

        {/* Secondary satellite sparkle gradient - pure white shimmer */}
        <linearGradient id={sparkle2Id} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" stopOpacity="1" />
 ...
 * No circular border or background; features a multi-shaded Gemini-style green star with glowing white sparkles in light mode.
