...
export default function EmptyState({
  ...
  return (
    ...
    >
      ...
      {title && (
        <p className="text-[10px] sm:text-xs font-bold text-text-secondary dark:text-dark-text-secondary">
          {title}
        </p>
      )}
      <p className="mt-1 sm:mt-2 text-xs sm:text-sm md:text-base font-light text-text-secondary dark:text-dark-text-secondary max-w-xs sm:max-w-md lg:max-w-lg mx-auto leading-relaxed">
        {description}
      </p>
