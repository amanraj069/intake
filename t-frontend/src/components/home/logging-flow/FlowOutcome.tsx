...
export function FlowPrompt() {
  return (
    <div
      className={`absolute left-[31cqw] top-[52cqw] flex h-[9cqw] w-[38cqw] items-center justify-center gap-[1.5cqw] rounded-[3cqw] bg-accent-muted dark:bg-accent-dark-muted text-white ${SOFT_SHADOW} animate-fade-up delay-350`}
    >
      <SparkleIcon className="h-[3.3cqw] w-[3.3cqw]" />
...
export function FlowResult() {
  return (
    <div
      className={`absolute left-[21cqw] top-[69cqw] w-[58cqw] rounded-[3cqw] border border-border/60 dark:border-dark-border bg-bg-card dark:bg-dark-bg-card px-[3cqw] py-[2.4cqw] ${SOFT_SHADOW} animate-fade-up delay-450`}
    >
